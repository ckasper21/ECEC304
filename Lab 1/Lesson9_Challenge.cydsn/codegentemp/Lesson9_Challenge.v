// ======================================================================
// Lesson9_Challenge.v generated from TopDesign.cysch
// 07/11/2017 at 12:19
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0cb66ef7-6d0a-4074-8301-548240e59fcf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a811676a-8f9e-41cc-857b-238c5d6cc5bd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("b69b3aa7-8081-4bf0-8ac7-6d71a4efefe9"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("29e9a4ee-067b-49a7-8308-b6a87da95998"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000000"),
		  .is_direct(0),
