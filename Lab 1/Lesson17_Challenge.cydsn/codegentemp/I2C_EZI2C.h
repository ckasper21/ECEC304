...
#define I2C_EZI2C_PRIMARY_SLAVE_ADDRESS    (8u)
#define I2C_EZI2C_SECONDARY_SLAVE_ADDRESS  (9u)
#define I2C_EZI2C_SUB_ADDRESS_SIZE         (0u)
#define I2C_EZI2C_WAKE_ENABLE              (1u)
#define I2C_EZI2C_DATA_RATE                (100u)
#define I2C_EZI2C_SLAVE_ADDRESS_MASK       (254u)
