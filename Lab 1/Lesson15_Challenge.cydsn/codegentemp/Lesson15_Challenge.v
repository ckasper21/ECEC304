// ======================================================================
// Lesson15_Challenge.v generated from TopDesign.cysch
// 07/13/2017 at 20:54
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_158 or Net_118 or Net_117 or Net_156 or Net_163)
        begin
            case (Net_163[1:0])
                2'b00 :  tmp__mux_1_reg = Net_158;
                2'b01 :  tmp__mux_1_reg = Net_118;
                2'b10 :  tmp__mux_1_reg = Net_117;
                2'b11 :  tmp__mux_1_reg = Net_156;
            endcase
        end
        assign Net_134 = tmp__mux_1_reg;
    end
    // -- Mux end --
