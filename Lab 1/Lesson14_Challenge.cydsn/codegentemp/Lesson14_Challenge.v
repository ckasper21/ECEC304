// ======================================================================
// Lesson14_Challenge.v generated from TopDesign.cysch
// 07/13/2017 at 20:06
...
module top ;
    ...
    // -- TFF Start --
    reg  cy_tff_2;
    always @(posedge Net_48)
    begin
        cy_tff_2 <= Net_50^Net_100;
    end
    assign Net_100 = cy_tff_2;
    // -- TFF End --
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_46)
    begin
        cy_tff_1 <= Net_47^Net_48;
    end
    assign Net_48 = cy_tff_1;
    // -- TFF End --


    assign Net_46 = ~Net_75;
    ...
    // -- TFF Start --
    reg  cy_tff_3;
    always @(posedge Net_100)
    begin
        cy_tff_3 <= Net_139^Net_142;
    end
    assign Net_142 = cy_tff_3;
    // -- TFF End --
